...
/* _pier_loop_talk(): initialize listeners.
*/
static void
_pier_loop_talk(void)
{
  c3_l cod_l;
                  ...
                  c3_o     nuu_o)
{
  ...
  */
  ...
  u3_unix_ef_look(c3n);
  u3_pier_plan(u3nt(u3_blip, c3__ames, u3_nul), u3nc(c3__kick, u3k(u3A->now)));
...
#if 0
/* _pier_boot_device(): introduce execution devices.
*/
static void
_pier_boot_device(u3_pier* pir_u,
                  c3_o     nuu_o)
{
}
#endif
